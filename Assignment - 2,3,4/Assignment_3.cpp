...
public:
    ...
    virtual float calculatePayment() const { return 0.0; }
};
...
public:
    ...
    void enrollInCourse(class Course* course) { courses.push_back(course); }
    ...
    float calculatePayment() const override { return 1000.0; }
};
...
public:
    ...
    void addTeachingHours(int hours) { teaching_assist_hours += hours; }
    void addResearchHours(int hours) { research_assist_hours += hours; }
...
// Department Class (Composition of Professors)
class Department {
    string name;
